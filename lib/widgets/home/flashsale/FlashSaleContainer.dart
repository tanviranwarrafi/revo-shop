            ...
            children: [
              Transform.translate(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(image: customImage != null ? NetworkImage(customImage) : AssetImage("images/lobby/laptop.png")),
                  ),
                  child: Container(width: double.infinity, height: double.infinity, color: colorTween.value),
                ),
              ),
              Container(
                ...
                child: loading
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, i) {
                          return i == 0
                              ? Container(height: double.infinity, width: MediaQuery.of(context).size.width / 3.0)
                              : InkWell(
                                  onTap: () {
                                    String productId = dataProducts[i].id.toString();
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => ProductDetail(productId: productId)));
                                  },
                                  child: Card(
                                    elevation: 5,
                                    child: Container(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: CachedNetworkImage(
                                              imageUrl: dataProducts[i].images[0].src,
                                              placeholder: (context, url) => Container(height: 25),
                                          ...
                                          Expanded(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Visibility(
                                                  visible: dataProducts[i].discProduct != 0,
                                                  child: Flexible(
                                                    flex: 2,
                                                    child: Row(
                                                      children: [
                                                        Container(
                                                          decoration:
                                                              BoxDecoration(borderRadius: BorderRadius.circular(5), color: secondaryColor),
                                                        ...
                                                        Container(width: 5),
                                                        Text(
                                                          stringToCurrency(double.parse(dataProducts[i].productRegPrice), context),
                                                          style: TextStyle(
                                                ...
                                                Flexible(
                                                  flex: 2,
                                                  child: Text(
                                                    stringToCurrency(double.parse(dataProducts[i].productPrice), context),
                                                    style: TextStyle(
                                                        fontSize: responsiveFont(10), color: secondaryColor, fontWeight: FontWeight.w600),
                                                  ),
                                                ),
                                                Container(height: 5),
                                                new LinearPercentIndicator(
                                                    ...
                                                    lineHeight: 5.0,
                                                    percent:
                                                        dataProducts[i].productStock != null && dataProducts[i].productStock != 0 ? 1 : 0,
                                                    backgroundColor: Colors.grey,
                                                    progressColor: HexColor("00963C")),
                                                Flexible(
                                                  flex: 1,
                                                  child: Text(
                                                    dataProducts[i].productStock != null && dataProducts[i].productStock != 0
                                                        ? "Stock Available"
                                                        : "Stock Empty",
