...
class FlashSaleCountdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (dataFlashSaleCountDown != null && !loading && dataFlashSaleCountDown.isNotEmpty) {
      endTime = DateTime.parse(dataFlashSaleCountDown[0].endDate).millisecondsSinceEpoch;
    }
    if (dataFlashSaleCountDown.isEmpty || endTime < timeNow) Container();
    return Column(
      children: [
        Container(
          ...
          child: Row(
            ...
            children: [
              Text("FLASH SALE", style: TextStyle(fontSize: responsiveFont(14), fontWeight: FontWeight.w600)),
              GestureDetector(
                onTap: () {
                  String include = flashSale.flashSales[0].products;
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ProductMoreScreen(include: include, name: 'FLASH SALE')),
                  );
                },
                child: Text(
            ...
            ? Visibility(
                ...
                child: CountdownTimer(
                  ...
                  widgetBuilder: (_, CurrentRemainingTime time) {
                    ...
                    if (time.days != null && time.days != 0) hours = (time.days * 24) + time.hours;
                    if (time == null) Text('Flash Sale Selesai');
                    return Container(
                      height: 30,
                      margin: EdgeInsets.only(left: 15, bottom: 10),
                      child: Row(
                        children: [
                          Container(width: responsiveFont(24), height: responsiveFont(24), child: Image.asset("images/lobby/thunder.png")),
                          Container(width: 10),
                          Container(
                          ...
                          Container(
                            ...
                            child: Text(":", style: TextStyle(color: secondaryColor, fontSize: responsiveFont(12))),
                          ),
                          Container(
