...
class BannerContainer extends StatelessWidget {
  ...
  BannerContainer({@required this.dataSliderLength, @required this.contentHeight, @required this.dataSlider, @required this.loading});
  ...
  Widget build(BuildContext context) {
    return Center(
      child: CarouselSlider.builder(
        ...
        options: CarouselOptions(enableInfiniteScroll: false, autoPlay: true, height: contentHeight / 6.5),
