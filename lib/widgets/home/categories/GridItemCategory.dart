...
class GridItemCategory extends StatelessWidget {
  ...
  GridItemCategory({this.i, this.itemCount, this.product, this.categoryName, this.categoryId});

  @override
  Widget build(BuildContext context) {
    if (i == 5) buildViewMore(context);
    return Container(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: responsiveFont(7)),
                                  ),
                                ),
                                Container(width: 5),
                                RichText(
                                  text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                          text: stringToCurrency(double.parse(product.productRegPrice), context),
                                          style: TextStyle(
                          ...
                          product.type == 'simple'
                              ? RichText(
                                  text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                        text: stringToCurrency(double.parse(product.productPrice), context),
                                    ...
                                    children: <TextSpan>[
                                      product.variationPrices.isEmpty
                                          ? TextSpan(
                                              text: '',
                                              style: TextStyle(
                                                  fontWeight: FontWeight.w600, fontSize: responsiveFont(11), color: secondaryColor),
                                            )
                                          : TextSpan(
                                              text: product.variationPrices.first == product.variationPrices.last
      ...
      child: Card(
        ...
        child: GestureDetector(
          onTap: () {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => BrandProducts(categoryId: catId, brandName: brandName)));
          },
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.add, color: secondaryColor, size: 28),
              ),
              Container(
                child: Text(
                  AppLocalizations.of(context).translate('view_more'),
                  style: TextStyle(color: secondaryColor, fontSize: responsiveFont(10), fontWeight: FontWeight.w500),
                ),
              ),
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontSize: responsiveFont(8), fontWeight: FontWeight.w400),
                ),
              )
            ],
          ),
