    ...
    return Container(
      ...
      child: ListView.separated(
          ...
          itemBuilder: (context, i) {
            ...
            return Container(
                margin: EdgeInsets.only(left: i == 0 ? 15 : 0, right: i == dataCategories.length - 1 ? 15 : 0),
                width: MediaQuery.of(context).size.width / 6,
                child: InkWell(
                  onTap: () {
                    if (titleCategories == 'View More') {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => CategoryScreen(isFromHome: false)));
                    } else {
                      String catId = dataCategories[i].categories.toString();
                      String brandName = dataCategories[i].titleCategories;
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => BrandProducts(categoryId: catId, brandName: brandName)),
                      );
                    }
                  },
                  child: Column(
                    ...
                    children: [
                      Flexible(flex: 3, child: itemCategory(imageCategories, i, type: titleCategories == 'View More' ? 'asset' : 'url')),
                      Container(height: 5),
                      Flexible(
                        flex: 3,
                        child: Container(
                          child: Text(
                            ...
                            style: TextStyle(fontSize: responsiveFont(8), fontWeight: FontWeight.w600),
                          ),
                        ),
                      )
                    ],
