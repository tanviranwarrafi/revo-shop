...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  static List<Widget> _widgetOptions = <Widget>[
    LobbyScreen(),
    BlogScreen(),
    CategoryScreen(isFromHome: true),
                        ...
                        Column(
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(fontSize: responsiveFont(14), fontWeight: FontWeight.w500),
                            ),
                            SizedBox(
                              height: 15,
                            ),
                            Text(
                              ...
                              textAlign: TextAlign.center,
                              style: TextStyle(fontSize: responsiveFont(12), fontWeight: FontWeight.w400),
                            ),
                          ],
                        ),
                        Container(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.only(bottomLeft: Radius.circular(15)), color: primaryColor),
                                      child: Text(
                                ...
                                Expanded(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      padding: EdgeInsets.symmetric(vertical: 12),
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.only(bottomRight: Radius.circular(15)), color: Colors.white),
                                      child: Text(
            ...
            children: <Widget>[
              Expanded(
                ...
                child: InkWell(
                  ...
                  child: Container(
                      child: navbarItem(0, "images/lobby/home.png", "images/lobby/homeClicked.png",
                          AppLocalizations.of(context).translate('home'), 28, 14)),
                ),
              ),
              Expanded(
                  flex: 2,
                  child: InkWell(
                    ...
                    child: Container(
                        child: navbarItem(1, "images/lobby/writing.png", "images/lobby/writingClicked.png",
                            AppLocalizations.of(context).translate('blog'), 28, 14)),
                  )),
              Expanded(
                  flex: 2,
                  child: InkWell(
                    ...
                    child: Container(
                        child: navbarItem(2, "images/lobby/category.png", "images/lobby/categoryClicked.png",
                            AppLocalizations.of(context).translate('category'), 28, 14)),
                  )),
              Expanded(
                  flex: 2,
                  child: InkWell(
                    ...
                    child: Container(
                        child: navbarItem(3, "images/lobby/cart.png", "images/lobby/cartClicked.png",
                            AppLocalizations.of(context).translate('cart'), 28, 14)),
                  )),
              Expanded(
                  flex: 2,
                  child: InkWell(
                    onTap: () {
                      ...
                      printLog(Session.data.getBool('isLogin').toString(), name: 'isLoginShared');
                      setState(() {
                        isAnimate[4] = true;
                    ...
                    child: Container(
                        child: navbarItem(4, "images/lobby/account.png", "images/lobby/accountClicked.png",
                            AppLocalizations.of(context).translate('account'), 28, 14)),
                  ))
            ],
          ),
        ),
      ...
      children: [
        ...
        AnimatedOpacity(
          ...
          child: AnimatedContainer(
              ...
              child: _selectedIndex == index ? Image.asset(clickedImage) : Image.asset(image)),
        ),
        Container(
