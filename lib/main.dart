...
void main() async {
  ...
  runApp(Phoenix(
    ...
    providers: [
      ...
      ChangeNotifierProvider<FlashSaleProvider>(create: (context) => FlashSaleProvider()),
      ChangeNotifierProvider<BlogProvider>(create: (context) => BlogProvider()),
      ChangeNotifierProvider<LoginProvider>(create: (context) => LoginProvider()),
      ChangeNotifierProvider<UserProvider>(create: (context) => UserProvider()),
      ChangeNotifierProvider<ProductProvider>(create: (context) => ProductProvider()),
      ChangeNotifierProvider<GeneralSettingsProvider>(create: (context) => GeneralSettingsProvider()),
      ...
      ChangeNotifierProvider<CouponProvider>(create: (context) => CouponProvider()),
      ...
      builder: () => ChangeNotifierProvider<AppNotifier>(
        ...
        child: Consumer<AppNotifier>(
          builder: (context, value, _) => MaterialApp(
            ...
            title: 'RevoShop',
            routes: <String, WidgetBuilder>{'HomeScreen': (BuildContext context) => HomeScreen()},
            ...
            home: Builder(
              builder: (context) {
                return FutureBuilder(
                    ...
                    builder: (_, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) Container();
