...
buildNotificationSubtitle(status, context) {
  ...
  if (status == 'pending') {
    subtitle = ' ${AppLocalizations.of(context).translate('status_order_pending')}';
  } else if (status == 'processing') {
    subtitle = ' ${AppLocalizations.of(context).translate('status_order_processing')}';
  } else if (status == 'on-hold') {
    subtitle = ' ${AppLocalizations.of(context).translate('status_order_on_hold')}';
  } else if (status == 'completed') {
    subtitle = ' ${AppLocalizations.of(context).translate('status_order_complete')}';
  } else if (status == 'cancelled') {
    subtitle = ' ${AppLocalizations.of(context).translate('status_order_cancel')}';
  } else if (status == 'refunded') {
    subtitle = ' ${AppLocalizations.of(context).translate('status_order_refund')}';
  } else if (status == 'failed') {
    subtitle = ' ${AppLocalizations.of(context).translate('status_order_failed')}';
  }
  return subtitle;
}
